...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('products')->insert([
            'name' => 'Travel Package',
            'description' => "Fully paid trip to the major cities of Italy. Lorem ipsum posuere commodo cursus dictumst habitasse curae dolor commodo, sollicitudin vestibulum sed tempor integer feugiat vitae at aenean sapien ullamcorper nostra malesuada blandit, vehicula iaculis turpis feugiat aptent curabitur, class sapien laoreet sagittis.",
        ...
        DB::table('products')->insert([
            ...
            'description' => "The Arnolfini Portrait is a 1434 oil painting on oak panel by the Early Netherlandish painter Jan van Eyck. It forms a full-length double portrait, believed to depict the Italian merchant Giovanni di Nicolao Arnolfini and his wife, presumably in their residence at the Flemish city of Bruges.",
        ...
        DB::table('products')->insert([
            ...
            'description' => "Overall size 18.5 x 12.8 x 0.3 cm. The slice polished on both sides to reveal the dense concentration of translucent to transparent brownish yellow to yellow green olivine crystals within the highly lustrous nickel-iron. With custom lucite base.
        ...
        DB::table('products')->insert([
            ...
            'description' => "Hermès Braise Birkin 35cm in Shiny Alligator Mississippiensis with Gold Hardware, 2000
        ...
        DB::table('products')->insert([
            ...
            'description' => "Of pendant design, featuring drop-shaped and round opal cabochons, framed and accented with round diamonds.
        ...
        DB::table('products')->insert([
            ...
            'description' => "Centering an oval yellow sapphire flanked by 2 tapered baguette diamonds.
        ...
        DB::table('products')->insert([
            ...
            'description' => "pair of allegorical groups: Carrying off Fame and Folly Supporting Spring
        ...
        DB::table('products')->insert([
            ...
            'description' => "Case: The case is in overall good condition with wear commensurate with age. Please note that the strap and buckle are generic and not signed Universal Geneve.
        ...
        DB::table('products')->insert([
            'name' => 'Beastie Boys',
            'description' => 'Gold Sales award presented to Mike D for the Beastie Boys 1999 anthology album “The Sounds of Science" for more 100,000 copies sold in the United Kingdom.',
        ...
        DB::table('products')->insert([
            ...
            'description' => "Brendan Murphy is an internationally acclaimed American painter, creative entrepreneur, former professional athlete, and founder of athletic clothing company Solfire. Murphy has traveled the world, laying roots in business, athletics, and creativity all along the way.
        ...
        DB::table('products')->insert([
            ...
            'description' => "Enamel snuff with bottles produced within the Zaobanchu (Imperial Household Department) in the Jiaqing period and enamelled with a Jiaqing reign mark are extremely rare. Only one other example appears to be recorded, an enamel snuff bottle with similarly articulated four-character kaishu mark, decorated with foreigners bearing tributes from the Qing court collection and still in Beijing, illustrated in Snuff Bottles. The Complete Collection of Treasures of the Palace Museum, Hong Kong, 2003, pl. 177.
        ...
        DB::table('products')->insert([
            ...
            'description' => "Overall size 15.0 x 13.0 x 11.0 cm. Centering on a central lustrous black schorl partially encased within the surround of stark white albite accented with sharply terminated colorless quartz and associated lepidolite books. With custom lucite base.
        ...
        DB::table('products')->insert([
            ...
            'description' => "Hand-knotted geometric rug from the Mid-Century Modern collection.
        ...
        DB::table('products')->insert([
            ...
            'description' => "Terracotta centerpiece featuring three standing putti.
        ...
        DB::table('products')->insert([
            ...
            'description' => "Sgarbi, Vittorio. Donatello e il suo tempo: Il bronzetto a Padova nel Quattrocento e nel Cinquecento. Publisher, Year. 
